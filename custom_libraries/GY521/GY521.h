...
public:
    ...
    void set_last_x_angle(float value);
    float get_last_x_angle();

    void set_last_y_angle(float value);
    float get_last_y_angle();

    void set_last_z_angle(float value);
    float get_last_z_angle();

    void set_last_gyro_x_angle(float value);
    float get_last_gyro_x_angle();

    void set_last_gyro_y_angle(float value);
    float get_last_gyro_y_angle();

    void set_last_gyro_z_angle(float value);
    float get_last_gyro_z_angle();

    void set_base_x_accel(float value);
    float get_base_x_accel();

    void set_base_y_accel(float value);
    float get_base_y_accel();

    void set_base_z_accel(float value);
    float get_base_z_accel();

    void set_base_x_gyro(float value);
    float get_base_x_gyro();

    void set_base_y_gyro(float value);
...
private:
    ...
    float wordToScaledFloat(int rawValue, float scale);
